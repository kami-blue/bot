...
const grabbifyRegex = new RegExp("(grabify.{0,3}link|leancoding.{0,3}co|leancoding.{0,3}co|leancoding.{0,3}co|freegiftcards.{0,3}co|joinmy.{0,3}site|curiouscat.{0,3}club|catsnthings.{0,3}fun|catsnthing.{0,3}com)");
...
async function autoResponder(message) {
    ...
    if (!message.member.hasPermission("BAN_MEMBERS")) {
        ...
        if (grabbifyRegex.test(cleanedMessage)||
