...
module.exports.run = async (client, message, args) => {
    if ((message.channel.id == "724349410858893372") || (message.channel.id == "722436626248237076")) {
        message.channel.send("2b2t полностью отключил пакеты от шалкеров, если вы фактически не нажмете правой кнопкой мыши на шалкер, то есть нет способа обойти это, и нет способа предварительного просмотра шалкеров на 2b.\nЭто относится ко всем клиентам, не только к KAMI Blue, потому что он также исправляет ванильный текст с `64х Обсидиан` в ванильной подсказке. Обхода нет.")
    } else {
