module.exports.modules = {
    antispam: {
        name: "AntiSpam",
        descriptionru: "\n**Категория**: Chat\n**Описание**: Удаляет рекламу и спам из чата.",
    ...
    baritoneremote: {
        name: "BaritoneRemote",
        descriptionru: "\n**Категория**: Chat\n**Описание**: Удаленный контроль Baritone для другого игрока через /msg.",
        descriptionen: "\n**Category**: Chat\n**Description**: Remotely control Baritone with /msg."
    },
    chatencryption: {
        name: "ChatEncryption",
        descriptionru: "\n**Категория**: Chat\n**Описание**: Шифрует и расшифровывает сообщения из чата.",
        descriptionen: "\n**Category**: Chat\n**Description**: Encrypts and decrypts chat messages."
    },
    chatfilter: {
        name: "ChatFilter",
        descriptionru: "\n**Категория**: Chat\n**Описание**: Убирает выбранные слова или фразы из чата.",
    ...
    antifriendhit: {
        name: "AntiFriendHit",
        descriptionru: "\n**Категория**: Combat\n**Описание**: Не атакует ваших друзей.",
        descriptionen: "\n**Category**: Combat\n**Description**: Don't hit your friends."
    },
    aura: {
        name: "Aura",
        descriptionru: "\n**Категория**: Combat\n**Описание**: Бьет по сущностям вокруг вас.",
    ...
    autofeetplace: {
        name: "AutoFeetPlace",
        descriptionru: "\n**Категория**: Combat\n**Описание**: Продолжительно кладёт обсидиан вокруг ваших ног.",
    ...
    autotrap: {
        name: "AutoTrap",
        descriptionru: "\n**Категория**: Combat\n**Описание**: Захватывает ваших врагов обсидианом.",
    ...
    crystalaura: {
        name: "CrystalAura",
        descriptionru: "\n**Категория**: Combat\n**Описание**: Ставит Кристаллы Края, чтобы убивать врагов.",
    ...
    antihunger: {
        name: "AntiHunger",
        descriptionru: "\n**Категория**: Movement\n**Описание**: Снижает потерю голода при движении",
    ...
    entityspeed: {
        name: "EntitySpeed",
        descriptionru: "\n**Категория**: Movement\n**Описание**: Используйте движение на стороне клиента чтобы преодолеть звуковой барьер, сидя на сущности",
    ...
    noslowdown: {
        name: "NoSlowDown",
        descriptionru: "\n**Категория**: Movement\n**Описание**: Предотвращает замедление при использовании предмета или прохождении через паутину",
    ...
    step: {
        name: "Step",
        descriptionru: "\n**Категория**: Movement\n**Описание**: Изменяет ванильную механику вставания на блок",
