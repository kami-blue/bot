...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.roles.cache.find(role => config["dj_role"] === role.name)) return message.channel.send("You do not have permissions to force skip!");
...
module.exports.config = {
    ...
    aliases: ["fs"],
    use: "forceskip",
    description: "Force Skips the song currently playing.",
    state : "gamma",
    page: 5
};
